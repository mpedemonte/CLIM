	...
	<head>
      ...
      function Elimina(id_foro){
        if (!confirm("¿Desea eliminar el resgistro "+id_foro+"?"))//OK=True Cancel=False
          return;
        url = "eliminarforoc.php?id_foro="+id_foro;
...
<a href="formularioadmin.php" style='color: white; background: #336699; :visited color: white; :hover background: #336699; :visited:hover color: white'> nuevo tema </a>
